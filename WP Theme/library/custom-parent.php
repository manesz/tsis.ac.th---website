...
function custom_parent_info() { 
	register_post_type('parent_info',
		array( 'labels' => array(
			...
			'singular_name' => __( 'Parent Info. Post', 'bonestheme' ),
			'all_items' => __( 'All Parent Info. Posts', 'bonestheme' ),
			'add_new' => __( 'Add New', 'bonestheme' ),
			'add_new_item' => __( 'Add New Parent Info.', 'bonestheme' ),
			'edit' => __( 'Edit', 'bonestheme' ),
			'edit_item' => __( 'Edit Parent Info.', 'bonestheme' ),
			'new_item' => __( 'New Parent Info.', 'bonestheme' ),
			'view_item' => __( 'View Parent Info.', 'bonestheme' ),
			'search_items' => __( 'Search Parent Info.', 'bonestheme' ),
...
add_action( 'init', 'custom_parent_info');
	register_taxonomy( 'parent_info_cat', 
		...
		array('hierarchical' => true,
			'labels' => array(
				'name' => __( 'Parent Info. Categories', 'bonestheme' ),
	...
	register_taxonomy( 'parent_info_tag', 
		...
		array('hierarchical' => false,
			'labels' => array(
				'name' => __( 'Parent Info. Tags', 'bonestheme' ),
