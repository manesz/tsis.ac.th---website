<?php
$highlight_show = get_option('achievements_show');
$mycategory = get_category_by_slug('achievements');
$catid = $mycategory->term_id;
if (!$mycategory) {
  $catid = wp_create_category('achievements', 0);
}
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Add Achievements</h4>
                </div>
...
var catslug = 'achievements',contentkey = 'achievements_show';
</script>
<script type="text/javascript">
var postidselect=0;
var contentHilight = {
