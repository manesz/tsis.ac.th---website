<?php
$highlight_show = get_option('highlight_show');
$mycategory = get_category_by_slug('highlight');
$catid = $mycategory->term_id;
if (!$mycategory) {
  $catid = wp_create_category('highlight', 0);
}
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Add Highlight</h4>
                </div>
...
var catslug = 'highlight',contentkey = 'highlight_show';
</script>
<script type="text/javascript">
var postidselect=0;
var contentHilight = {
